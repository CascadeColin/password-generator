...
const formStyle = "flex flex-col items-center";

const formInputLengthStyle =
  "text-black h-[20px] w-11 ml-[10px] bg-none border border-black rounded-sm outline-none";

const formLabelStyle = "leading-7 mb-[10px]";

const buttonStyle =
  "rounded p-1 bg-slate-600 hover:bg-slate-500 transition duration-200 mt-2 text-white";

const copyConfirmationStyle = "text-center";

export const passwordGenStyle = {
  buttonStyle,
  passwordHeaderStyle,
  ...
  formHeaderStyle,
  formStyle,
  formInputLengthStyle,
  formLabelStyle,
  passwordContainerStyle,
  formSubcontainerLeftStyle,
  formSubcontainerRightStyle,
  copyConfirmationStyle,
};
